...
void test(){
    ...
    pTif = XTIFFOpen( "/Users/ken/workspace/Landsat/LT51070352000049HAJ00/LT51070352000049HAJ00_B1.TIF", "r" );
    ...
    GTIFKeyGet( pGTif, GeogGeodeticDatumGeoKey, &DatumGeoKey, 0, 1);
    ...
    std::cout << nEllipse << std::endl;
    std::cout << DatumGeoKey << std::endl;
